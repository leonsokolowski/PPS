...
@Component({
  ...
  standalone: true,
  imports: [IonItem, IonLabel, CommonModule, FormsModule, ReactiveFormsModule,IonContent,IonInput,IonButton, IonCard, IonCardHeader, IonCardContent,
     IonCardTitle, RouterModule]
})
