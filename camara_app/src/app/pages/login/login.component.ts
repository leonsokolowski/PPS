...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonInput, IonButton, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonItem, IonLabel } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonLabel, IonItem, CommonModule, FormsModule, ReactiveFormsModule,IonContent,IonInput,IonButton, RouterModule]
})
